    ...
    if (dialog.open == true){
        ...
        switch(Id){
            case "dialogBio1":
                ...
                document.getElementById("arrowBio1").className = "fa-solid fa-arrow-down";
                break;
            case "dialogBio2":
                ...
                document.getElementById("arrowBio2").className = "fa-solid fa-arrow-down";
                break;
            case "dialogBio3":
        ...
        switch(Id){
            case "dialogBio1":
                ...
                document.getElementById("arrowBio1").className = "fa-solid fa-arrow-up";
                break;
            case "dialogBio2":
                ...
                document.getElementById("arrowBio2").className = "fa-solid fa-arrow-up";
                break;
            case "dialogBio3":
